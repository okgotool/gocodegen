...
import { listSysRole, getSysRole, delSysRole, addSysRole, updateSysRole, refreshCache } from "@/api/sysrole/sysrole";
...
function handleUpdate(row) {
  ...
  getSysRole(dictId).then(response => {
